...
Node* buildSimpleMechanicExample2()
{
  ...
  ExternalInteract* externalInteract2 = new ExternalInteract("ExternalInteract2");
  ...
  group->connect(rigidBody->getPort("externalInteractLink"),
                 externalInteract->getPort("link"));
  group->connect(rigidBody2->getPort("externalInteractLink"),
                 externalInteract2->getPort("link"));
