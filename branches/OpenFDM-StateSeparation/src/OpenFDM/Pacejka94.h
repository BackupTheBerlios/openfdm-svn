...
#ifndef OpenFDM_Pacejka94_H
#define OpenFDM_Pacejka94_H

#include "PacejkaTire.h"

namespace OpenFDM {

class Pacejka94 : public PacejkaTire {
  OPENFDM_OBJECT(Pacejka94, PacejkaTire);
public:
  ...
  const real_type& getA15() const { return mA15; }
  void setA15(const real_type& value) { mA15 = value; }
  ...
  const real_type& getA16() const { return mA16; }
  void setA16(const real_type& value) { mA16 = value; }

  const real_type& getA17() const { return mA17; }
  void setA17(const real_type& value) { mA17 = value; }
  ...
  const real_type& getA14() const { return mA14; }
  void setA14(const real_type& value) { mA14 = value; }

  const real_type& getDLAT() const { return mDLAT; }
  void setDLAT(const real_type& value) { mDLAT = value; }

  const real_type& getBCDLAT() const { return mBCDLAT; }
  void setBCDLAT(const real_type& value) { mBCDLAT = value; }
  ...
  const real_type& getB13() const { return mB13; }
  void setB13(const real_type& value) { mB13 = value; }
  ...
  const real_type& getB11() const { return mB11; }
  void setB11(const real_type& value) { mB11 = value; }

  const real_type& getB12() const { return mB12; }
  void setB12(const real_type& value) { mB12 = value; }

  const real_type& getDLON() const { return mDLON; }
  void setDLON(const real_type& value) { mDLON = value; }

  const real_type& getBCDLON() const { return mBCDLON; }
  void setBCDLON(const real_type& value) { mBCDLON = value; }
  ...
  const real_type& getC18() const { return mC18; }
  void setC18(const real_type& value) { mC18 = value; }
  ...
  const real_type& getC19() const { return mC19; }
  void setC19(const real_type& value) { mC19 = value; }

  const real_type& getC20() const { return mC20; }
  void setC20(const real_type& value) { mC20 = value; }
...
private:
  ...
  real_type mA6, mA7, mA16, mA17;
  real_type mA8, mA9, mA10;
  real_type mA11, mA12, mA13, mA14;
  real_type mDLAT, mBCDLAT;

  real_type mB0;
  real_type mB1, mB2;
  real_type mB3, mB4, mB5;
  real_type mB6, mB7, mB8, mB13;
  real_type mB9, mB10;
  real_type mB11, mB12;
  real_type mDLON, mBCDLON;

  real_type mC0;
  real_type mC1, mC2, mC18;
  real_type mC3, mC4, mC5, mC6;
  real_type mC7, mC8, mC9, mC10, mC19, mC20;
